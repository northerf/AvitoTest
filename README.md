...
**4. Ввести в консоль "docker-compose up"** --- ** ВАЖНОЕ замечание: проверьте порты перед запуском и освободите 8080 и 5432 **
...
### Также можно проверить, зайдя в БД "docker exec -it <Название или ID-контейнера> psql -U user -d mydb и введя запрос "SELECT * FROM users;" "
